...
router.get("/verA",(req,res)=>{
    res.render("verArmas");

});
router.get("/ArmaA",(req,res)=>{
    res.render("ArmaA");
...
router.post("/ArmaA",(req,res,next)=>{
